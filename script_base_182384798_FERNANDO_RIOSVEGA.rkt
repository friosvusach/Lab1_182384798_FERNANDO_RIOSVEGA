...
(require "tda_carta_182384798_FERNANDO_RIOSVEGA.rkt")
(require "tda_juego_182384798_FERNANDO_RIOSVEGA.rkt")
(require "tda_utiles_182384798_FERNANDO_RIOSVEGA.rkt")
...
;; La ejecución de cada turno es llamar al requerimiento de juego-jugar-turno con el uso de la función (juego-lanzar-dado semilla1 semilla2)
...
;; Explicación:
;; Al usar la semilla 1 y 2 para dado1 y dado2, jugador Carlos se va a mover a posición 3 (0 + dado1:1 + dado2: 2) 
...
;; cre(define prop6 (propiedad 6 "Plaza San Carlos" 800 10 #f 0 #f #f))
;; comprarPropiedad_or_construirCasa: #t
;; construirHotel: #f
;; pagarMultaSalirCarcel: #f
;; usarTarjetaSalirCarcel: #f
...
; Cae a posición 14 donde la propiedad cuesta 900 y cómo usa el valor #t de la propiedad entonces procede a comprar
...
g7 ;; esto imprime g7 
;; para verificar que todo esté correcto g7 va a entregar que el jugador 1 carlos tiene saldo/prespuesto 0 eso implica de que el jugador se encuentra en bancarrota y no se puede seguir jugando

; El comando jugador-esta-en-bancarrota se debe ejecutar al final del juego para el usuario vea en pantalla si efectivamente algun jugador se encuentra en bancarrota y que el juego termino
(jugador-esta-en-bancarrota p1) ;; va a entregar #t
